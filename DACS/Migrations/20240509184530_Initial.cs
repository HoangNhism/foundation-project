            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExclusiveID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExclusiveName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExclusiveDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExclusivePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exclusives_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
